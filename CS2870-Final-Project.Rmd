...
The following graph shows the number of crimes committed on people of varying ages. The ages range from 0-90 and the number of crimes committed range from 0-300,000. We created this graph to get a general understanding of who the most crimes were being committed against. We expected the bulk of the crimes to be committed against middle-aged people and we were correct in our prediction. 
...
This graph shows the number of crimes committed during each hour of the day. The number of crimes range from 0-7000. Like the previous graph, our initial predictions were correct. We thought that there would be a spike in crimes as the it got closer to midnight and the evening hours. We made this graph to see if there were any trends or patterns in the times that crimes occured.
...
The graph above clearly indicates there is not a direct relationship between the victims age and type of crime, their sex, and the time the crime occurred. We don't think using knn regression would improve our accuracy as there is no clear relationship between the data points.


## Conclusion

During our analysis, we found that middle aged citizens are most likelqy to have a crime committed against them, the ages with the highest amount of crimes committed against them were ages 25-43. We also found that the most dangerous times of the day in terms of crime are from the hours of 7pm to midnight with the highest number of crimes being committed during these hours, the safest times are 2am to 8am. According to the data, Hispanic people are most likely to have a crime committed against them, Being follow by White and Black people respectively. During Covid the crime rates overall dropped significantly. They went back up over the years and eventually the crime rates against females rose above those of males.
